...
class Search:
  ...
  def info():
    """
    Бот производит поиск людей
    по заданным параметрам в социальной сети "Вконтакте".
    Введите данные:
    - пол
    - возраст
    - город
    - семейное положение
    Далее бот находит кандидатов и возвращает
    для просмотра топ-3 фотографии профиля
